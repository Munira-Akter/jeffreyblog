<x-layouts>
    ...
    <main class="max-w-6xl mx-auto mt-6 lg:mt-20 space-y-6">
        <h1 class="text-center text-bold text-lg my-10">Log In</h1>
        <form action="/login" method="post" class="bg-gray-100 p-10 max-w-2xl  mx-auto">
            @csrf
              ...
              <div class="mb-6">
                <button type="submit" class="w-full bg-blue-500 py-2 text-bold text-white-600">LogIn</button>
              </div>
